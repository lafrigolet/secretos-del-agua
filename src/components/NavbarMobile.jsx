  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full h-[44px] bg-primary border-b border-black z-50 flex items-center justify-between px-4 md:hidden">
        ...
        {/* Center logo */}
        <a href="https://www.secretosdelagua.com/" className="absolute left-1/2 -translate-x-1/2">
      ...
      {/* Dropdown menu */}
      <div
        className={`fixed top-[44px] left-0 w-full bg-primary border-b border-gray-800 z-50 overflow-hidden transition-all duration-500 ease-in-out ${
          isMobileMenuOpen
